...
## Проверка координат (примечание, не часть исходного документа)

Проверено 23 сентября 2026 года. Координаты извлечены из заголовков `Location` HTTP-ответов `302 Found` по ссылкам исходного документа. После перенаправления обе страницы вернули `200 OK`. Значения приведены в порядке «широта, долгота» без округления относительно ссылок; точность положения на местности отдельно не проверялась.

| Турбина | Широта | Долгота | Исходная ссылка | Адрес назначения без служебных параметров |
| --- | --- | --- | --- | --- |
| 1 | 43.645150 | 78.535604 | [Google Maps](https://maps.app.goo.gl/iN6svMt69D5qRpFU9) | [43.645150, 78.535604](https://www.google.com/maps/search/43.645150,+78.535604) |
| 2 | 43.643198 | 78.538828 | [Google Maps](https://maps.app.goo.gl/8UQMwsYavY6nLvFY8) | [43.643198, 78.538828](https://www.google.com/maps/search/43.643198,+78.538828) |
